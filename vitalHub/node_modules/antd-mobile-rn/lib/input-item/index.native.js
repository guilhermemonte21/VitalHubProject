    ...
    (0, _createClass3['default'])(InputItem, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_Input2['default'], (0, _extends3['default'])({ editable: editable, clearButtonMode: clear ? 'while-editing' : 'never', underlineColorAndroid: 'transparent', ref: function ref(el) {
                ...
                editable && clear && value && _reactNative.Platform.OS === 'android' ? _react2['default'].createElement(
                    _reactNative.TouchableOpacity,
                    { style: [styles.clear], onPress: this.onInputClear, hitSlop: { top: 5, left: 5, bottom: 5, right: 5 } },
                    _react2['default'].createElement(_reactNative.Image, { source: require('../style/images/cross_w.png'), style: { width: 12, height: 12 } })
                ) : null,
                ...
                error && _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(_reactNative.Image, { source: require('../style/images/error.png'), style: {
