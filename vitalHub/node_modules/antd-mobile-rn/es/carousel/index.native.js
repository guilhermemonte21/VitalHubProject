...
import { Platform, ScrollView, StyleSheet, Text, View, InteractionManager } from 'react-native';
    ...
    function Carousel(props) {
        ...
        _this.paging = function (offsetY) {
            ...
            if (Platform.OS === 'android' && vertical) {
                ...
                // tslint:disable-next-line:no-unused-expression
                _this.scrollviewRef && _this.scrollviewRef.scrollTo({ x: 0, y: (_selectedIndex + (infinite ? 1 : 0)) * height });
            ...
            _this.setState({
                ...
                if (Platform.OS === 'android') {
                    ...
                    InteractionManager.runAfterInteractions(function () {
                        return _this.scrollviewRef && _this.scrollviewRef.scrollTo({ x: offsetX, y: offsetY, animated: false });
                    });
                }
            });
        };
