...
import { Image, StyleSheet, Text, TouchableWithoutFeedback, View, Platform, TouchableOpacity } from 'react-native';
    ...
    _createClass(InputItem, [{
        ...
        value: function render() {
            ...
            var _a = this.props,
                ...
                styles = _a.styles,
                restProps = __rest(_a, ["type", "editable", "clear", "children", "error", "extra", "labelNumber", "last", "onExtraClick", "onErrorClick", "styles"]);var value = restProps.value,
            ...
            return React.createElement(
                ...
                React.createElement(Input, _extends({ editable: editable, clearButtonMode: clear ? 'while-editing' : 'never', underlineColorAndroid: 'transparent', ref: function ref(el) {
                        return _this2.inputRef = el;
                    } }, restProps, valueProps, { style: [styles.input, error ? styles.inputErrorColor : null], keyboardType: keyboardType, onChange: function onChange(event) {
                ...
                editable && clear && value && Platform.OS === 'android' ? React.createElement(
                    TouchableOpacity,
                    { style: [styles.clear], onPress: this.onInputClear, hitSlop: { top: 5, left: 5, bottom: 5, right: 5 } },
                    React.createElement(Image, { source: require('../style/images/cross_w.png'), style: { width: 12, height: 12 } })
                ) : null,
                ...
                error && React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(Image, { source: require('../style/images/error.png'), style: {
